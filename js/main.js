...
(function ($) {
    ...
    // $('.about_img_1').click(function () {
    //     if ($('.raggi').is('.activated')) {
    //         $('.raggi').toggleClass('activated');
    //         $('.jogui').toggleClass('activated');
    //     }
    // });

    // $('.about_img_2').click(function () {
    //     if ($('.jogui').is('.activated')) {
    //         $('.raggi').toggleClass('activated');
    //         $('.jogui').toggleClass('activated');
    //     }
    // });
    ...
    $(document).ready(function () {
        if (localStorage.getItem("lang") == "pt") {
            $('.select-language1').addClass("selected-lang");
            $('.select-language2').removeClass("selected-lang");
        } else {
            $('.select-language2').addClass("selected-lang");
            $('.select-language1').removeClass("selected-lang");
        }
    });

    $('.select-language1').click(function () {
        localStorage.setItem("lang", "pt");
    });

    $('.select-language2').click(function () {
